...
const PROGRAM_ITEMS: ProgramNavItem[] = [
  ...
  { slug: 'mtm-future-today', label: 'MTM The Future Today', Icon: ClipboardCheck },
  { slug: 'test-and-treat', label: 'Test and Treat: Strep, Flu, COVID', Icon: Stethoscope },
  { slug: 'hba1c-testing', label: 'HbA1c Testing', Icon: Activity },
  { slug: 'oral-contraceptives', label: 'Oral Contraceptives', Icon: TestTubes },
];
